    ...
    <form onSubmit={handleSubmit}>
      ...
      <div className={compact ? 'mt-3 space-y-2' : 'space-y-4'}>
        ...
        <Recaptcha
          ...
          className={`${compact ? '!-mb-8 [transform:scale(0.58)]' : '-mb-3 [transform:scale(0.95)]'} flex origin-top justify-center`}
        />
        ...
        <div className="relative z-10 mx-auto max-w-[1200px] px-6 pt-10 pb-12 lg:pt-14 lg:pb-24">
          ...
          <div className="grid items-start gap-10 lg:grid-cols-2 lg:gap-12">
            ...
            <div>
              ...
              <div
                id="quote-form"
                className="mx-auto mb-8 mt-4 block w-[94%] max-w-[460px] scroll-mt-24 rounded-2xl border-2 border-phsOrange bg-white p-4 text-phsInk shadow-xl sm:p-6 lg:hidden"
              >
                <BookingForm
